...
const TYPE_STYLES = {
  ...
  Other:     { badge: 'bg-slate-700/60 text-slate-300 border-slate-600',    dot: 'bg-slate-400'    },
};
...
export default function ConnectivityCard({ system }) {
  ...
  return (
    <div className="bg-slate-800 border border-slate-700 rounded-2xl p-4">
      <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Connectivity</div>
      <div className="space-y-2.5">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="text-xs text-slate-400 shrink-0">Public</span>
          </div>
        ...
        {interfaces.length > 0 && <div className="border-t border-slate-700/60" />}
          ...
          return (
            <div key={iface.name} className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <span className="text-xs text-slate-400 truncate">{iface.name}</span>
              </div>
